defmodule LiveBeats.Repo.Migrations.SetupLivebeatsActsFdw do
  use Ecto.Migration
  ...
  def up do
    ...
    execute "CREATE SCHEMA IF NOT EXISTS livebeats_acts_fdw;"
    ...
    IMPORT FOREIGN SCHEMA public
      ...
      INTO livebeats_acts_fdw;
    """
  end

  def down do
    execute "DROP SCHEMA IF EXISTS livebeats_acts_fdw CASCADE;"
